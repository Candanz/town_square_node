export const JINXES = [
  ...
  {
    roles: ['baron', 'heretic'],
    description: 'The Baron might only add 1 Outsider, not 2.',
  },
  {
    roles: ['baron', 'plaguedoctor'],
    description:
      'If the Storyteller gains the Baron ability, up to two players become not-in-play Outsiders.',
  },
  {
    roles: ['boomdandy', 'plaguedoctor'],
    description:
  ...
  {
    roles: ['pithag', 'heretic'],
    description: 'A Pit-Hag can not create a Heretic.',
  },
  {
    roles: ['pithag', 'ogre'],
    description:
  ...
  {
    roles: ['spy', 'alchemist'],
    description: 'The Alchemist can not have the Spy ability.',
  },
  {
    roles: ['spy', 'damsel'],
    description: 'If the Spy is (or has been) in play, the Damsel is poisoned.',
  },
  {
    roles: ['spy', 'heretic'],
    description: 'Only 1 jinxed character can be in play.',
  ...
  {
    roles: ['riot', 'butler'],
    description: 'The Butler can not nominate their master.',
  },
  {
    roles: ['riot', 'cannibal'],
    description:
  ...
  {
    roles: ['riot', 'clockmaker'],
    description: 'Riot registers as a Minion to the Clockmaker.',
  },
  {
    roles: ['riot', 'damsel'],
  ...
  {
    roles: ['riot', 'flowergirl'],
    description: 'Only 1 jinxed character can be in play.',
  },
  {
    roles: ['riot', 'golem'],
    description: 'If the Golem nominates Riot, the Riot player does not die.',
  },
  {
    roles: ['riot', 'grandmother'],
    description:
  ...
  {
    roles: ['riot', 'innkeeper'],
    description:
      'If a Riot player nominates an Innkeeper-protected-player, the Innkeeper-protected-player does not die.',
  },
  {
    roles: ['riot', 'investigator'],
    description: 'Riot registers as a Minion to the Investigator.',
  },
  {
    roles: ['riot', 'king'],
    description:
  ...
  {
    roles: ['riot', 'preacher'],
    description: 'Riot registers as a Minion to the Preacher.',
  },
  {
    roles: ['riot', 'ravenkeeper'],
    description:
  ...
  {
    roles: ['riot', 'towncrier'],
    description: 'Riot registers as a Minion to the Town Crier.',
  },
  {
    roles: ['riot', 'undertaker'],
    description:
      'Players that die by nomination register as being executed to the Undertaker.',
  },
  {
    roles: ['vortox', 'banshee'],
    description:
